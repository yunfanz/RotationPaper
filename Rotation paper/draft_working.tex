...
the sensitivity by up to a factor of 1.3. 
...
We shall use the 128-element PAPER array to demonstrate, and extend our results to several HERA configurations in Sec \ref{sec:arrconf}. 
