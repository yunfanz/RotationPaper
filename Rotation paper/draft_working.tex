...
\end{equation}
where $L$ is the baseline length. We assumed for simplicity only a single $L$ even in the near-equivalent case because only baselines of nearly equal length would have high redundancy (see Fig.\ref{fig:pairplot}). 
